        ...
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={"/"} className='flex items-center gap-2'>
                    ...
                    <p className='text-headingColor text-xl font-bold'>LaCha</p>
                </Link>
                ...
                <div className='flex items-center gap-8'>
                    <motion.ul
                        ...
                        <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer'>List</li>
                        ...
                        />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    {
                                        user && user.email === "khucduyquang1801@gmail.com" && (
                                            <Link to={'/createItem'}>
                        ...
                        isMenu && (
                            <motion.div
                                ...
                                <ul
                                    ...
                                    <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2' onClick={() => setIsMenu(false)}>List</li>
